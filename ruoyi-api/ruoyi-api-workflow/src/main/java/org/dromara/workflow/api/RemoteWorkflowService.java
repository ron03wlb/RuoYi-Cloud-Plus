...
/**
 * Common workflow service interface.
 *
 * <p>This interface provides comprehensive workflow operations including process instance
 * management, task handling, and workflow variable manipulation for distributed workflow systems.
 *
 * @author ZETA
 * @since 2024/6/3
 */
