...
class SysUserServiceImplTest extends BaseUnitTest {
  ...
  class QueryTests {
    ...
    void shouldSelectUserByIdWithRoles() {
      ...
      List<SysRoleVo> roles =
          Arrays.asList(
              TestDataFactory.createRoleVo(1L, "admin"), TestDataFactory.createRoleVo(2L, "user"));
    ...
    void shouldSelectUserPostGroup() {
      ...
      List<SysPostVo> posts =
          Arrays.asList(
              TestDataFactory.createPostVo(1L, "CEO"), TestDataFactory.createPostVo(2L, "CTO"));
  ...
  class BoundaryTests {
    ...
    void shouldHandleNullDeptId() {
      ...
      List<SysUserVo> expectedUsers =
          Arrays.asList(
              TestDataFactory.createUserVo(1L, "user1"), TestDataFactory.createUserVo(2L, "user2"));
      // Directly mock selectUserList method
      when(baseMapper.selectUserList(ArgumentMatchers.<Wrapper<SysUser>>any()))
          .thenReturn(expectedUsers);
