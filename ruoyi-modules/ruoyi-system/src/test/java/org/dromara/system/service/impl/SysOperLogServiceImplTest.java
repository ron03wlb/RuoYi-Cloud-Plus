  ...
  class QueryMethodsTests {
    ...
    void shouldReturnOperLogList_WhenQueryByOperName() {
      ...
      List<SysOperLogVo> expectedList =
          Arrays.asList(
              createOperLogVo(1L, "新增用户", 0, "系统管理员"), createOperLogVo(2L, "修改用户", 0, "系统管理员"));
    ...
    void shouldReturnOperLogList_WhenQueryByBusinessType() {
      ...
      List<SysOperLogVo> expectedList =
          Arrays.asList(
              createOperLogVo(1L, "新增用户", 0, "admin"), createOperLogVo(2L, "新增角色", 0, "admin"));
      when(baseMapper.selectVoList(any(LambdaQueryWrapper.class))).thenReturn(expectedList);
    ...
    void shouldReturnOperLogList_WhenQueryByBusinessTypes() {
      ...
      List<SysOperLogVo> expectedList =
          Arrays.asList(
              createOperLogVo(1L, "新增用户", 0, "admin"), createOperLogVo(2L, "修改用户", 0, "admin"));
      when(baseMapper.selectVoList(any(LambdaQueryWrapper.class))).thenReturn(expectedList);
    ...
    void shouldReturnOperLogList_WhenQueryByStatus() {
      ...
      // Assert
      assertThat(result).isNotNull().hasSize(2).extracting(SysOperLogVo::getStatus).containsOnly(0);
