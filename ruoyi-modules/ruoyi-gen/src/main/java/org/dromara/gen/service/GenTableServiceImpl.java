...
public class GenTableServiceImpl implements IGenTableService {
    ...
    private QueryWrapper<GenTable> buildGenTableQueryWrapper(GenTable genTable) {
        ...
        wrapper.eq(
                        StringUtils.isNotEmpty(genTable.getDataName()),
                        "data_name",
                        genTable.getDataName())
                .like(
                        StringUtils.isNotBlank(genTable.getTableName()),
                        "lower(table_name)",
                        StringUtils.lowerCase(genTable.getTableName()))
                .like(
                        StringUtils.isNotBlank(genTable.getTableComment()),
                        "lower(table_comment)",
