...
public class SysOssConfigServiceImpl implements ISysOssConfigService {
    ...
    private LambdaQueryWrapper<SysOssConfig> buildQueryWrapper(SysOssConfigBo bo) {
        ...
        lqw.eq(
                ...
                SysOssConfig::getConfigKey,
                bo.getConfigKey());
        lqw.like(
                StringUtils.isNotBlank(bo.getBucketName()),
    ...
    public Boolean deleteWithValidByIds(Collection<Long> ids, Boolean isValid) {
        ...
        if (flag) {
            list.forEach(
                    sysOssConfig ->
                            CacheUtils.evict(
                                    CacheNames.SYS_OSS_CONFIG, sysOssConfig.getConfigKey()));
        }
        return flag;
    }
    ...
    public int updateOssConfigStatus(SysOssConfigBo bo) {
        ...
        int row =
                baseMapper.update(
                        null,
                        new LambdaUpdateWrapper<SysOssConfig>().set(SysOssConfig::getStatus, "1"));
