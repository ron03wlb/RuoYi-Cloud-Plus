  ...
  class HandleNotLoginExceptionTests {
    ...
    void shouldReturn401ForNotLogin() {
      ...
      NotLoginException exception =
          NotLoginException.newInstance("user", NotLoginException.NOT_TOKEN, "未提供Token", null);
    ...
    void shouldHandleTokenExpiredException() {
      // Arrange
      NotLoginException exception =
          NotLoginException.newInstance("user", NotLoginException.TOKEN_TIMEOUT, "Token已过期", null);
    ...
    void shouldHandleTokenBeReplacedException() {
      // Arrange
      NotLoginException exception =
          NotLoginException.newInstance("user", NotLoginException.BE_REPLACED, "Token已被顶下线", null);
