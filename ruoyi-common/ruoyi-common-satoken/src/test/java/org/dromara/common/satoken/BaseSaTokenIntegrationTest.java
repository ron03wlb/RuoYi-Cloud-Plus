 ...
 * Sa-Token 集成測試基類
 * <p>
 * 提供完整的 Spring Boot 測試環境 + 真實的 Redis 容器
 * </p>
 *
 * <p>特性:</p>
 * <ul>
 *   <li>完整 Spring Boot 上下文</li>
 *   <li>Testcontainers Redis 容器</li>
 *   <li>Sa-Token 完整功能</li>
 ...
 * <p>適用場景:</p>
 * <ul>
 *   <li>需要真實 Redis 環境的測試</li>
 *   <li>Sa-Token 登錄/權限測試</li>
 *   <li>需要驗證 Token 存儲行為的測試</li>
 * </ul>
 *
 * @author Test Team
 */
...
public abstract class BaseSaTokenIntegrationTest {
     ...
     * 動態配置屬性
     * <p>
     * 從 Testcontainers 獲取動態端口並配置到 Spring
     * </p>
     */
     ...
     * 測試應用配置
     * <p>
     * 最小化 Spring Boot 應用，僅包含 Sa-Token 必需的組件
     * </p>
     */
