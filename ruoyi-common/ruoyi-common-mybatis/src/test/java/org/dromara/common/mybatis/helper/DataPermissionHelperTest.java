...
class DataPermissionHelperTest extends BaseUnitTest {
  ...
  class ContextVariableTests {
    ...
    /**
     * NOTE: Context variable tests require SaHolder context initialization. In pure unit test mode
     * (without Spring/Sa-Token context), getContext() returns a new HashMap each time, so
     * persistence tests will fail. These tests document the expected behavior in integration test
     * mode.
     */
    @Test
