...
public enum FormatsType {
  ...
  /**
   * Gets the FormatsType by matching the time format string.
   *
   * @param str the string to match against time formats
   * @return the matched FormatsType
   * @throws RuntimeException if no matching FormatsType is found
   */
