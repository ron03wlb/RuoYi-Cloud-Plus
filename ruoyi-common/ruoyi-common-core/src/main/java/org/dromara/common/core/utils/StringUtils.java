...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
  ...
  /**
   * Formats text with {} as placeholder.<br>
   * This method simply replaces {} placeholders in order with parameters.<br>
   * To output {}, use \\escape { ; to output \ before {}, use double escape \\\\.<br>
   * Examples:<br>
   * Normal use: format("this is {} for {}", "a", "b") -> this is a for b<br>
   * Escape {}: format("this is \\{} for {}", "a", "b") -> this is {} for a<br>
   * Escape \: format("this is \\\\{} for {}", "a", "b") -> this is \a for b.<br>
   *
   * @param template text template where parts to be replaced use {}
  ...
  /**
   * Checks if url matches the pattern configuration. ? represents single character; * represents
   * any string within one path level; ** represents any path levels.
   *
