...
/**
 * IP address geolocation utility class using offline mode. Reference: <a
 * href="https://gitee.com/lionsoul/ip2region/tree/master/binding/java">Integrate ip2region for
 * offline IP geolocation library</a>.
 *
 * @author lishuyan
 */
@Slf4j
public class RegionUtils {
  ...
  /**
   * Gets city information offline by IP address.
   *
   * @param ip the IP address
   * @return the city information string
   */
