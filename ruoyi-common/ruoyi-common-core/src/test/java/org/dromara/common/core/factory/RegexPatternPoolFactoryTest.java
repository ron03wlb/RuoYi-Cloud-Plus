...
class RegexPatternPoolFactoryTest extends BaseUnitTest {
  ...
  class PatternConstantsTests {
    ...
    void shouldInitializeQQNumberPattern() {
      ...
      assertThat(RegexPatternPoolFactory.QQ_NUMBER.pattern()).isEqualTo(RegexConstants.QQ_NUMBER);
    }
    ...
    void shouldInitializePasswordPattern() {
      ...
      assertThat(RegexPatternPoolFactory.PASSWORD.pattern()).isEqualTo(RegexConstants.PASSWORD);
    }
