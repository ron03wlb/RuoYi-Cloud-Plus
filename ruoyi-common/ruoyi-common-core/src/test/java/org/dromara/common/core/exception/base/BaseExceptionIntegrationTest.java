...
class BaseExceptionIntegrationTest extends BaseIntegrationTest {
  ...
  class GetMessageIntegrationTest {
    ...
    void shouldReturnCodeWhenCodeNotFoundInMessageSource() {
      ...
      LocaleContextHolder.setLocale(Locale.SIMPLIFIED_CHINESE);
      BaseException exception =
          new BaseException(null, "non.existent.code", new Object[] {"param"}, "这是默认错误消息");
  ...
  class RealScenarioTest {
    ...
    void shouldHandleFileSizeExceededScenario() {
      ...
      LocaleContextHolder.setLocale(Locale.SIMPLIFIED_CHINESE);
      BaseException exception =
          new BaseException("file", "file.upload.msg.sizeLimitExceeded", new Object[] {10});
    ...
    void shouldHandlePasswordRetryLimitExceededScenario() {
      ...
      LocaleContextHolder.setLocale(Locale.SIMPLIFIED_CHINESE);
      BaseException exception =
          new BaseException("auth", "user.password.retry.limit.exceed", new Object[] {30}, "账户已锁定");
  ...
  class BoundaryTest {
    ...
    void shouldHandleSpecialCharactersInArgs() {
      ...
      BaseException exception =
          new BaseException(
              "user.password.retry.limit.count", new Object[] {"<script>alert('xss')</script>"});
