...
class SqlUtilTest extends BaseUnitTest {
    ...
    class FilterKeywordTest {
        ...
        void shouldNotThrowForNullOrEmpty(String value) {
            assertThatCode(() -> SqlUtil.filterKeyword(value))
        ...
        void shouldPassForNormalData() {
            assertThatCode(() -> SqlUtil.filterKeyword("张三"))
                .doesNotThrowAnyException();
            assertThatCode(() -> SqlUtil.filterKeyword("测试数据123"))
                .doesNotThrowAnyException();
    ...
    class IntegrationTest {
        ...
        void shouldUseBothProtectionMechanisms() {
            ...
            // 再检查关键字
            assertThatCode(() -> SqlUtil.filterKeyword(escaped))
                .doesNotThrowAnyException();
        }
    ...
    class EdgeCasesTest {
        ...
        void shouldHandleVeryLongString() {
            ...
            assertThatCode(() -> SqlUtil.filterKeyword(longString))
                .doesNotThrowAnyException();
        }
        ...
        void shouldHandleWhitespaceOnly() {
            ...
            assertThatCode(() -> SqlUtil.filterKeyword(whitespace))
                .doesNotThrowAnyException();
        }
        ...
        void shouldHandleKeywordAsPartOfText() {
            ...
            assertThatCode(() -> SqlUtil.filterKeyword("android"))
                .doesNotThrowAnyException();
        ...
        void shouldHandleUnicodeCharacters() {
            // 包含emoji
            assertThatCode(() -> SqlUtil.filterKeyword("测试😀数据"))
                .doesNotThrowAnyException();
