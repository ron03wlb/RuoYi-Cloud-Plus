...
class AddressUtilsTest {
  ...
  class GetRealAddressByIPv4Test {
    ...
    void shouldReturnLocalAddressForPrivateIPv4() {
      // 10.0.0.0/8
      assertThat(AddressUtils.getRealAddressByIP("10.0.0.1")).isEqualTo(AddressUtils.LOCAL_ADDRESS);
  ...
  class GetRealAddressByIPBoundaryTest {
    ...
    void shouldHandleInvalidIpFormat() {
      assertThat(AddressUtils.getRealAddressByIP("invalid-ip")).isEqualTo(AddressUtils.UNKNOWN_IP);

      assertThat(AddressUtils.getRealAddressByIP("256.256.256.256"))
          .isEqualTo(AddressUtils.UNKNOWN_IP);

      assertThat(AddressUtils.getRealAddressByIP("192.168.1")).isEqualTo(AddressUtils.UNKNOWN_IP);
    ...
    void shouldHandleHostname() {
      ...
      assertThat(AddressUtils.getRealAddressByIP("localhost")).isEqualTo(AddressUtils.UNKNOWN_IP);
    }
  }
  ...
  class GetRealAddressByIPRealScenarioTest {
    ...
    void shouldHandleEnterprisePrivateNetworks() {
      // 企业常用网段
      assertThat(AddressUtils.getRealAddressByIP("10.1.1.1")).isEqualTo(AddressUtils.LOCAL_ADDRESS);
