  ...
  class CaptchaExceptionTests {
        ...
        assertThatCode(
                () -> {
                  java.lang.reflect.Field field =
                      CaptchaException.class.getDeclaredField("serialVersionUID");
    ...
    class RealWorldScenarioTests {
      ...
      void shouldHandleInvalidCaptchaFormat() {
        ...
        // Assert
        assertThat(thrown).isInstanceOf(CaptchaException.class).isInstanceOf(UserException.class);
      }
    }
  }
    ...
    class SerializationTests {
      ...
      void shouldDefineSerialVersionUID() {
        ...
        assertThatCode(
                () -> {
                  java.lang.reflect.Field field =
                      CaptchaExpireException.class.getDeclaredField("serialVersionUID");
                  field.setAccessible(true);
                  long serialVersionUID = field.getLong(null);
                  assertThat(serialVersionUID).isEqualTo(1L);
                })
