...
class BusinessStatusEnumTest extends BaseUnitTest {
  ...
  class GetByStatusTests {
    ...
    @ParameterizedTest
    @ValueSource(
        strings = {"cancel", "draft", "waiting", "finish", "invalid", "back", "termination"})
  ...
  class RunningStatusTests {
    ...
    void shouldReturnRunningStatusList() {
      ...
      assertThat(runningStatus).hasSize(4).containsExactly("draft", "waiting", "back", "cancel");
    }
  ...
  class CheckStartStatusTests {
    ...
    void shouldAllowStartForDraftCancelBack(String status) {
      assertThatCode(() -> BusinessStatusEnum.checkStartStatus(status)).doesNotThrowAnyException();
    }
  ...
  class CheckCancelStatusTests {
    ...
    void shouldAllowCancelForDraftWaiting(String status) {
      assertThatCode(() -> BusinessStatusEnum.checkCancelStatus(status)).doesNotThrowAnyException();
    }
  ...
  class CheckBackStatusTests {
    ...
    void shouldAllowBackForDraftWaiting(String status) {
      assertThatCode(() -> BusinessStatusEnum.checkBackStatus(status)).doesNotThrowAnyException();
    }
