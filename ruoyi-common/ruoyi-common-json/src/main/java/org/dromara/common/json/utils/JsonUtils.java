...
public class JsonUtils {
  ...
  public static List<Dict> parseArrayMap(String text) {
    ...
    try {
      return getObjectMapper()
          .readValue(
              text,
              getObjectMapper().getTypeFactory().constructCollectionType(List.class, Dict.class));
    } catch (IOException e) {
      throw new RuntimeException(e);
    }
  }
  ...
  public static <T> List<T> parseArray(String text, Class<T> clazz) {
    ...
    try {
      return getObjectMapper()
          .readValue(
              text, getObjectMapper().getTypeFactory().constructCollectionType(List.class, clazz));
    } catch (IOException e) {
      throw new RuntimeException(e);
    }
  }
