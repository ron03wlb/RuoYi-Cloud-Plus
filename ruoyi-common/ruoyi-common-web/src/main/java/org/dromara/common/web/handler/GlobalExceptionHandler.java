...
public class GlobalExceptionHandler {
    ...
    public R<Void> handleBindException(BindException e) {
        ...
        String message =
                StreamUtils.join(
                        e.getAllErrors(), DefaultMessageSourceResolvable::getDefaultMessage, ", ");
    ...
    public R<Void> constraintViolationException(ConstraintViolationException e) {
        ...
        String message =
                StreamUtils.join(
                        e.getConstraintViolations(), ConstraintViolation::getMessage, ", ");
        return R.fail(message);
    }
    ...
    public R<Void> handleHttpMessageNotReadableException(
        ...
        return R.fail(
                HttpStatus.HTTP_BAD_REQUEST, "请求参数格式错误：" + e.getMostSpecificCause().getMessage());
    }
}
