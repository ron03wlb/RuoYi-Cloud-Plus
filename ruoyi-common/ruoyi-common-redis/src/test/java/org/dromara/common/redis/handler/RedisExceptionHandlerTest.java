...
class RedisExceptionHandlerTest extends BaseUnitTest {
  ...
  class HandleLockFailureExceptionTests {
    ...
    void shouldHandleLockAlreadyHeldException() {
      ...
      LockFailureException exception =
          new LockFailureException("Lock 'order:create:123' is already held by another thread");
  ...
  class BusinessScenarioTests {
    ...
    void shouldHandlePaymentLockFailure() {
      ...
      LockFailureException exception = new LockFailureException("Payment processing lock is busy");
  ...
  class DifferentLockTypeTests {
    ...
    void shouldHandleReadWriteLockFailure() {
      // Arrange
      LockFailureException exception = new LockFailureException("Write lock acquisition timeout");
