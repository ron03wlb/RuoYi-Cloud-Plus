...
public class SequenceUtils {
  ...
  public static String getDateId(
    ...
    return getDateId(
        prefix, isWithPrefix, minIdCapacityBits, time, DEFAULT_INIT_VALUE, DEFAULT_STEP_VALUE);
  }
   ...
   *
   * @return 唯一id
   * @deprecated 请使用 {@link #getDateTimeId(String)} 或 {@link #getDateTimeId(String, boolean)}、{@link
   *     #getDateTimeId(String, boolean, int)}，确保不同业务的ID连续性
   */
  @Deprecated
