...
public class RedisConfiguration {
     ...
     * 客户端名称 clientName: ${ruoyi.name} # master最小空闲连接数 masterConnectionMinimumIdleSize: 32 #
