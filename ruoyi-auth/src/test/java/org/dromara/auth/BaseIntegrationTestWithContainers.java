 ...
 * 集成测试基类（使用本地Redis）
 *
 * <p>提供完整的 Spring Boot 测试环境 + 本地 Redis
 *
 * <p>特性:
 *
 * <ul>
 *   <li>完整 Spring Boot 上下文
 *   <li>本地 Redis (localhost:6379)
 *   <li>提供 MockMvc 用于 Controller 测试
 ...
 *
 * <ul>
 *   <li>需要本地 Redis 运行: docker run -d --name test-redis -p 6379:6379 redis:7-alpine
 * </ul>
 *
 * <p>适用场景:
 *
 * <ul>
 *   <li>Controller 层集成测试
 *   <li>Service 层需要 Spring 容器的测试
 *   <li>需要验证 Redis 缓存行为的测试
 * </ul>
 *
 * @author Test Team
 */
