...
class SysLoginServiceIntegrationTest extends BaseIntegrationTestWithContainers {
  ...
  class CheckTenantTests {
    ...
    void shouldThrowExceptionWhenTenantIdIsBlank() {
      // Act & Assert
      assertThatThrownBy(() -> sysLoginService.checkTenant("")).isInstanceOf(TenantException.class);
    ...
    void shouldPassWhenTenantIsValid() {
      ...
      // Act & Assert
      assertThatNoException().isThrownBy(() -> sysLoginService.checkTenant(tenant.getTenantId()));
    }
  }
}
