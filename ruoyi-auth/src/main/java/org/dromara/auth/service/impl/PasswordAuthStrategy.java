...
/**
 * Password authentication strategy implementation for username/password login.
 *
...
public class PasswordAuthStrategy implements IAuthStrategy {
  ...
  public LoginVo login(String body, RemoteClientVo client) {
    ...
    log.debug(
        "Password login attempt: username={}, tenantId={}, clientId={}",
        username,
        tenantId,
        client.getClientId());
    ...
    log.info(
        "Password login successful: userId={}, username={}, tenantId={}, clientId={}",
        loginUser.getUserId(),
        username,
        tenantId,
        client.getClientId());
