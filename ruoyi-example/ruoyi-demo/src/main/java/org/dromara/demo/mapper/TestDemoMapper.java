...
public interface TestDemoMapper extends BaseMapperPlus<TestDemo, TestDemoVo> {
  ...
  Page<TestDemoVo> customPageList(
      @Param("page") Page<TestDemo> page, @Param("ew") Wrapper<TestDemo> wrapper);
  ...
  default <P extends IPage<TestDemoVo>> P selectVoPage(
      IPage<TestDemo> page, Wrapper<TestDemo> wrapper) {
