...
public class PushMessageController {
  ...
  @Autowired private NormalRabbitProducer normalRabbitProducer;
  @Autowired private DelayRabbitProducer delayRabbitProducer;
  @Autowired private NormalRocketProducer normalRocketProducer;
  @Autowired private TransactionRocketProducer transactionRocketProducer;
  @Autowired private KafkaNormalProducer normalKafkaProducer;
